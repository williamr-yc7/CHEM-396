...
#ifndef LMP_PAIR_MTPS_KOKKOS_EXTRAPOLATION_H
#define LMP_PAIR_MTPS_KOKKOS_EXTRAPOLATION_H
...
template <class DeviceType> class PairMTPsExtrapolationKokkos : public PairMTPExtrapolation {
 public:
  // Structs for kernels
  ...
  PairMTPsExtrapolationKokkos(class LAMMPS *);
  ~PairMTPsExtrapolationKokkos() override;
 ...
 protected:
  ...
  friend void pair_virial_fdotr_compute<PairMTPsExtrapolationKokkos>(PairMTPsExtrapolationKokkos *);
};
...
template <class DeviceType> struct sComputeNbhGrades {
  ...
  Kokkos::View<F_FLOAT **, Kokkos::LayoutRight, DeviceType> d_nbh_energy_ders_wrt_moments;
  Kokkos::View<F_FLOAT ***, DeviceType> d_radial_jacobian;
  Kokkos::View<F_FLOAT **, Kokkos::LayoutRight, DeviceType> d_moment_tensor_vals;
  ...
  sComputeNbhGrades(
      ...
      int coeff_count_,
      Kokkos::View<F_FLOAT **, Kokkos::LayoutRight, DeviceType> d_nbh_energy_ders_wrt_moments_,
      Kokkos::View<F_FLOAT ***, DeviceType> d_radial_jacobian_,
      Kokkos::View<F_FLOAT **, Kokkos::LayoutRight, DeviceType> d_moment_tensor_vals_,
...
template <class DeviceType> struct sComputeCfgGrade {
  ...
  sComputeCfgGrade(int coeff_count_, Kokkos::View<F_FLOAT *, DeviceType> d_energy_ders_wrt_coeffs_,
                   Kokkos::View<F_FLOAT **, DeviceType> d_inverse_active_set_) :
