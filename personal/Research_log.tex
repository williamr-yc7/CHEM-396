...
%To confirm that crystalline silicon (c-Si) has melted into a liquid at 2500 K in a simulation, look for the loss of long-range order in the radial distribution function (RDF), an increase in the coordination number, and high mean square displacement (MSD).
