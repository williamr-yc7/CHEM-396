...
The NPT test was run at 300~K and 0~bar and expanded the box from $4325$ to $4433$~\AA$^3$, corresponding to $a=5.476$~\AA. This is $0.8\%$ above the measured value of $5.431$~\AA, an overestimate consistent with the PBE\footnote{Perdew-Burke-Ernzerhof, the generalized gradient approximation exchange-correlation functional used to generate the MTP training data.} reference data used to train the potential.
...
\subsubsection{Quench P22}
\subsubsection{Quench pruned\_1}
\subsubsection{Quench pruned\_2}
\subsubsection{Quench pruned\_3}
