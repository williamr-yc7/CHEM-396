...
August 13 & Meeting with Lena and Ata on the quench results. Follow-up analysis assigned: whether the large-excursion atoms are the defective ones, whether defects migrate between neighbours, and the defect mean square displacement. \\
August 14 & MAP tutorial with Ata. Voxel size left open pending a comparison of training and validation loss; grid fixed at $80^3$, implying a box near 40~\AA{} and a move to 4096 atoms. \\
