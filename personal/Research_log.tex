...
\begin{itemize}
    ...
    \item \textbf{Mean square displacement.} Flat at approximately $0.1$~\AA$^2$ for the first 25.5~ps, the plateau of atoms vibrating about fixed lattice sites, then rising linearly to 110~\AA$^2$ by the end of the ramp. Unbounded linear growth is the definitive signature of diffusion, and the transition coincides with the potential-energy jump and volume contraction seen in the thermodynamic output.
    \item %Tetrahedral Order Parameter
    \item %Density
\end{itemize}
%add a frame which will include all figures for the 5 signatures
\begin{figure}[H]
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[width=1\linewidth]{../python/radial_dist_fct/melt_P22_rdf_output.png}
        \label{fig:sfig1}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=1\linewidth]{../python/msd/melt_P22_msd_output.png}
        \label{fig:sfig3}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=1\linewidth]{../python/coord_num/melt_P22_cn_output.png}
        \label{fig:sfig2}
    \end{subfigure}
    \caption{(a) Radial distribution function; (b) Coordination number; (c) Mean square displacement; (d) ;}
    \label{fig:fig}
\end{figure}
